...
\end{table}
		...
		$(x_{11} + x_{21})(x_{12} + x_{22})(x_{13} + x_{23})(x_{11}x_{12} \lor x_{11}x_{13} \lor x_{12}x_{13})$ % need check
		...
		$(x_{11} \lor x_{21})(\bar{x}_{11} \lor \bar{x}_{21})(x_{12} \lor x_{22})(\bar{x}_{12} \lor \bar{x}_{22})(x_{13} \lor x_{23})(\bar{x}_{13} \lor \bar{x}_{23})
		(\bar{x}_{11} \lor \bar{x}_{12})(\bar{x}_{11} \lor \bar{x}_{13})(x_{12} \lor x_{13})(\bar{x}_{21} \lor \bar{x}_{22})
...
\end{example}
	...
	\begin{definition}
		...
		$xy = \overline{\bar{x}\bar{y}} = x \lor y
