...
\begin{document}
    ...
    $\forall x_{________________}$ Всегда 1, значит ответ 1, если хотя бы раз 0, то и общий ответ 0

    $\exists x_{________________}$ Надо вычислить внутреннюю часть для всех х
    ...
    \begin{example}
        ...
        Дизъюнкты: $\overline{H(x)} \lor M(x);$ H(сократ); \overline{M($сократ$)}
